...
export const adminRouter = [
  ...
  //商品管理
  {
    ...
    children: [
      {path:'add-prod-info',hidden: true,  component:()=>import('@/admin/product/addProdInfo.vue'),meta:{title:"添加商品"}},
