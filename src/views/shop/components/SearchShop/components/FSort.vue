...
<div class="f-sort">
  ...
  <div class="check">
    <HCheckbox @change="changeCheck" v-model="sortParams.inventory">仅显示有货商品</HCheckbox>
    <HCheckbox @change="changeCheck" v-model="sortParams.onlyDiscount">仅显示特惠商品</HCheckbox>
  </div>
</div>
</template>
