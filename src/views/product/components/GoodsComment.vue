<template>
  <div class="goods-comment">
    ...
    <!-- 分页组件 -->
    <HPagination v-if="total" @current-change="changePagerFn" :page-size="reqParams.pageSize" :current-page="reqParams.page" />
  </div>
</template>
<script>
import { inject, reactive, ref, watch } from 'vue'
import { findGoodsCommentInfo, findGoodsCommentList } from '@/api/shop'
import GoodsCommentImage from './goods-comment-image'
import HPagination from '@/components/HPagination.vue'
export default {
  name: 'GoodsComment',
  components: { HPagination, GoodsCommentImage },
  setup () {
    // 获取评价信息
